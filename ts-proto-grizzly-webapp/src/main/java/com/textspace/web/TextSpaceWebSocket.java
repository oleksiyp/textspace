...
* Time: 9:38 PM
*/
public class TextSpaceWebSocket extends DefaultWebSocket implements TextSpaceOutput
{
    private final TextSpaceInput input;

    private final UserState state = new UserState(this);

    public TextSpaceWebSocket(TextSpaceInput input, ProtocolHandler handler, WebSocketListener[]listeners) {
